...
[← Back to Lab 04 Overview](./README.md) | [Next: Evaluate Model Performance →](./02-evaluate-model-performance.md)

---

## Overview

In this step, you will configure IBM watsonx.governance to monitor your deployed machine learning model. You'll set up training data, fairness monitoring, quality thresholds, drift detection, and explainability features.

---

## 1.1 Access Deployment Space

1. From watsonx.ai home page, click **Hamburger icon** in top right side
2. Expand **Deployment Spaces**
3. Click **View all deployment spaces**

<img width="304" height="450" alt="image" src="https://github.com/user-attachments/assets/2884bf1e-6c38-4cf4-a7c0-f1259f2c9496" />

4. Select **"Repurchase Model Deployment Space"** (or your deployment space from Lab 03)

<img width="513" height="123" alt="image" src="https://github.com/user-attachments/assets/75a26b4f-475a-4721-8117-365e04f10628" />

5. Go to **Deployments** tab
6. Select **"Repurchase Model Endpoint"**

<img width="1702" height="311" alt="image" src="https://github.com/user-attachments/assets/99cc3a77-d82a-4603-ac8a-71a0d730e10f" />

---

## 1.2 Initialize OpenScale Evaluation

1. Go to **Evaluations** tab
2. Click **Configure OpenScale evaluation settings** button
...
4. Check **"Allow service to create, use and store credentials via task credentials"** checkbox
...
## 1.4 Configure Fairness Monitoring

1. Click **Fairness** in left pane
2. Click **Pencil icon** in Configuration section
...
5. Ensure **"Y"** is set as **Favorable** and **"N"** is set as **Unfavorable**
6. Click **Next** button
...
9. Select **Statistical Parity Difference**
...
11. Leave the configuration as default
...
15. Ensure **"Male"** is set to **Monitored** and **"Female"** is set to **Reference**
