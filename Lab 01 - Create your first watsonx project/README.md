...
12. Type "db2" in the **Search** field → select **IBM Db2** → ensure IBM Db2 is selected in the right panel → click the **Next** button

<img width="1815" height="879" alt="image" src="https://github.com/user-attachments/assets/2100b52e-a198-44a2-b58c-92f2e10d1451" />

13. Set **Name** to "db2-connection" in the **Connection overview** section
...
16. Check **Port is SSL-Enabled** → set **SSL Certificate** to:
    ```
